...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-blue-200 dark:bg-gray-100 dark:text-gray-800">
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">© 2048 VelvetVoices Co. All rights reserved.</div>
        </footer>
    );
};
